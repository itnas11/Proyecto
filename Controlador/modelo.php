...
class Cliente{
		...
		static function getAll($link){
			$consulta="SELECT * FROM clientes where admin !=1";
		...
		function modificar ($link){
			$consulta="UPDATE clientes SET nombre='$this->nombre',  direccion='$this->direccion',  email='$this->email', pwd='$this->pwd', admin='$this->admin' WHERE dniCliente='$this->dniCliente'";
			return $link->query($consulta);
		}
